...
class MonthlyTrendView(APIView):
    """
    Monthly spending + income trend for the last 12 months.
    ...
    def get(self, request):
        ...
        for i in range(12):
            ...
            result.append({
                ...
                'savings': income_map.get(key, 0) - expense_map.get(key, 0),
            })
        ...
        result = [
            {
                ...
                'percentage': round((float(b['total']) / total * 100), 1) if total > 0 else 0,
            }
            for b in breakdown
        ]
